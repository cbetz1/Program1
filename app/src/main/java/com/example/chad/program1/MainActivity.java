...
public class MainActivity extends AppCompatActivity {
    ...
    public void onGenerateBio(View view) {
        ...
        String messageText = "Hello my name is " + firstNameView.getText().toString() + " " + lastNameView.getText().toString() + ". I attend(ed) " + schoolView.getText().toString() + " and graduate(d) in " + yearGradView.getText().toString() + " with a "
                 + degreeView.getText().toString().toUpperCase() + " degree in " + majorView.getText().toString() + ". I enjoy " + favActivitiesView.getText().toString() + ".";
